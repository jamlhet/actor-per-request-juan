...
import co.s4n.template.routing.PerRequestObject.WithProps
import spray.http.{StatusCode, StatusCodes}
import spray.routing.RequestContext

trait PerRequestObject extends Actor with ActorLogging {
...
object PerRequestObject {

  case class WithProps(r: RequestContext, props: Props, message: RestMessage) extends PerRequestObject {
